...
function [optimal_torque, min_energy] = minimize_energy_consumption_regenerative(speed_vector, acceleration_vector, gearnumber_vector, wm_list, Tm_list, efficiency_map, m,wr,cr,cd,g,rho_a,gear_ratios ,dt,Tmmax)
